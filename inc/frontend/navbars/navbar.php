  ...
  <div class="padding-y-2 padding-x-2 tablet:padding-x-4">
    <div class="display-flex flex-align-center">
      ...
      <nav role="navigation" class="usa-nav display-flex flex-align-center flex-fill">
        ...
        <div class="desktop:order-last display-flex desktop:flex-fill flex-align-center desktop:flex-justify-end">
        ...
        <div class="desktop:display-flex width-full desktop:width-auto flex-align-center">
            <?php
            $args =  array(
